...
\setbeamertemplate{bibliography entry location}{(40, 90)}
...
\begin{textblock}{43}(0.5, 85)
  ...
  \begin{itemize}
    \item Three main sources of beam-induced backgrounds at FCC-ee~~\cite{Voutsinas:2017eca} \vspace{0.5cm}
    \begin{itemize}
