...
First, the geometry of the detector is described using the DD4hep simulation framework. The implementation of the detectors in the interaction region for the IDEA detector is shown in \cref{fig_sim} and includes the beam pipe, the luminosity calorimeter, the vertex detector and the drift chamber.
