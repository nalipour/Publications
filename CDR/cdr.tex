...
\caption{The trajectory of the $e^+e^-$ pairs in a 2~T magnetic field for E\textsubscript{cm}=365~GeV.}
\label{fig_pairbcg}
\end{figure}
...
\caption{The percentage of wires hit due to $e^+e^-$ background as a function of the layer radius for collisions at (a) E\textsubscript{cm}=91.2~GeV and (b) E\textsubscript{cm}=365~GeV.}
