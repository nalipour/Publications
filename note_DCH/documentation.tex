...
The following script is used to run a simulation using particle gun from \testsc{Geant4}. The output is written in a PODIO file. The output contains the energy deposits calculated by \testsc{Geant4} at each \textsc{G4Step}.
